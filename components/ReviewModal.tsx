...
const ReviewModal: React.FC<ReviewModalProps> = ({
  ...
  const minReceivedStr = minReceived.toLocaleString("en-US", {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-background-card border border-strong rounded-[2rem] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 flex flex-col">
        {/* Header - Consistent with BridgeModal */}
        <div className="px-6 py-4 border-b border-subtle flex items-center justify-between bg-zinc-900/50 backdrop-blur-md">
          <div>
            ...
            <p className="text-[9px] font-bold text-content-tertiary uppercase tracking-widest mt-0.5">
              {styles.desc} Execution
            </p>
          </div>
          <button
            onClick={onClose}
            className="p-1.5 text-content-tertiary hover:text-white bg-zinc-900/50 hover:bg-background-surface rounded-lg transition-colors border border-subtle"
          >
            <X size={16} />
          </button>
        </div>
        ...
        <div className="px-6 py-6 flex flex-col gap-2">
          ...
          <div className="flex flex-col">
            <div className="flex justify-between items-center mb-1">
              ...
              <div className="flex items-center gap-1.5 px-2 py-0.5 bg-background-card rounded-md border border-subtle">
                {/* Placeholder Icon */}
          ...
          <div className="flex items-center gap-4 py-2 opacity-50">
            <div className="h-px bg-background-surface flex-1"></div>
            <div className="p-1 rounded-full bg-background-card border border-subtle text-content-tertiary">
              <ArrowDown size={14} />
            </div>
            <div className="h-px bg-background-surface flex-1"></div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div
              className={`text-3xl lg:text-4xl font-mono font-medium tracking-tight tabular-nums truncate ${styles.text}`}
            >
              {data.receiveAmount}
            </div>
          </div>
        ...
        <div className="px-6 pb-6">
          <div className="bg-zinc-900/40 rounded-2xl p-5 border border-subtle space-y-3">
            {/* Rate */}
            <div className="flex justify-between items-center text-[11px]">
              <span className="text-content-tertiary font-medium">Rate</span>
            ...
            <div className="flex justify-between items-center text-[11px]">
              ...
              <span className="text-content-secondary font-mono font-bold">
                ~0.05%
              </span>
            </div>
            ...
            <div className="flex justify-between items-center text-[11px]">
              ...
              <span className="text-zinc-200 font-mono font-bold">
                {minReceivedStr} {data.receiveToken}
              </span>
            </div>
