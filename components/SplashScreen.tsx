...
const Logo = () => (
  <svg
    ...
    className="w-24 h-24 text-emerald-500 animate-pulse drop-shadow-[0_0_25px_rgba(16,185,129,0.6)]"
    fill="currentColor"
...
export const SplashScreen: React.FC<{ onFinish: () => void }> = ({
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-background flex flex-col items-center justify-center w-screen h-[100dvh] overflow-hidden select-none">
      {/* Background Ambience */}
      ...
      <div className="relative z-10 flex flex-col items-center gap-12 max-w-md w-full px-6 animate-in fade-in zoom-in duration-700">
        ...
        <div className="flex flex-col items-center gap-8">
          <Logo />
          <h1 className="text-6xl font-black text-white tracking-[0.2em] uppercase drop-shadow-[0_0_20px_rgba(255,255,255,0.4)]">
            Cryptix
          </h1>
        </div>
        ...
        <div className="w-full max-w-xs flex flex-col items-center gap-4">
          {/* Bar */}
          <div className="w-full h-1.5 bg-background-card rounded-full overflow-hidden border border-subtle relative">
            <div
          ...
          {/* Percentage */}
          <div className="flex justify-between w-full text-[10px] font-mono text-content-tertiary font-bold uppercase tracking-widest">
        ...
        <div className="h-8 flex items-center justify-center">
          <p className="text-[10px] font-bold text-content-tertiary uppercase tracking-[0.2em] animate-pulse text-center">
            {SLOGANS[sloganIndex]}
          </p>
        </div>
      </div>
