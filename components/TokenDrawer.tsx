...
const TokenDrawer: React.FC<TokenDrawerProps> = ({ isOpen, onClose }) => {
  ...
  return createPortal(
    <div className="relative z-[9999]">
      ...
      >
        {/* HEADER SECTION */}
        <div className="flex-shrink-0 pt-16 px-8 pb-6 border-b border-subtle bg-zinc-900/80 backdrop-blur-xl relative">
          <button
            onClick={onClose}
          ...
          <div className="flex items-start space-x-4 mb-5">
            <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center shadow-lg">
              <img
                src="https://logotyp.us/file/fetch-ai.svg"
                alt="Fetch ai"
            ...
            <div>
              <div className="flex items-center space-x-2 mb-0.5">
                ...
                <span className="px-1.5 py-0.5 rounded text-[9px] font-bold uppercase tracking-widest bg-background-surface text-content-secondary border border-strong">
                  AI Sector
                </span>
              </div>
          ...
          <div className="flex justify-between items-end">
            <div>
              <p className="text-[9px] font-bold text-content-secondary uppercase tracking-widest mb-1">
                Price
              </p>
            ...
            <div className="text-right">
              ...
              <span className="text-lg font-mono font-bold text-content-secondary">
                $428M
              </span>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8 scrollbar-hide bg-background-card">
          ...
          <section>
            ...
            <div className="bg-zinc-900/30 border border-subtle p-5 rounded-lg relative overflow-hidden">
              <div className="relative z-10">
                <p className="text-xs font-medium text-content-secondary leading-relaxed">
                  <strong className="text-white">Sector Rotation:</strong> FET
                  lags sector avg by{" "}
                  <span className="text-zinc-200 border-b border-zinc-600">
                    15%
                  </span>
                  . Rotation from NVIDIA equities into top-cap Crypto AI assets
                  expected this week.
                </p>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="bg-zinc-900/30 border border-subtle rounded-lg p-6 grid grid-cols-3 gap-6">
              {/* 1. ENTRY ZONE */}
              <div className="flex flex-col border-r border-subtle">
                <span className="text-[9px] font-bold text-content-tertiary uppercase tracking-widest mb-2">
                  Entry Zone
                </span>
              ...
              {/* 2. INVALIDATION */}
              <div className="flex flex-col border-r border-subtle pl-4">
                <span className="text-[9px] font-bold text-content-tertiary uppercase tracking-widest mb-2">
                  Invalidation
                </span>
                ...
                <span className="text-[9px] font-mono font-bold text-rose-500/70 mt-1">
                  -4.3%
                </span>
              </div>
              ...
              <div className="flex flex-col pl-4">
                ...
                <span className="text-[9px] font-mono font-bold text-emerald-500/70 mt-1">
                  R:R 2.6
                </span>
              </div>
            </div>
            <div className="mt-2 flex items-center justify-end">
              <span className="text-[9px] font-bold text-content-tertiary uppercase tracking-wider flex items-center gap-1">
                <AlertTriangle size={10} className="text-content-tertiary" />
        ...
        <div className="flex-shrink-0 p-6 border-t border-subtle bg-zinc-950/90 backdrop-blur-xl">
          ...
          <div className="flex justify-between items-center mb-4 px-1">
            <div className="flex items-center gap-2 text-[10px] text-content-tertiary font-medium">
              <ArrowLeftRight size={12} />
              <span>
                ETH <span className="text-content-tertiary">→</span> FET via{" "}
                <span className="text-white font-bold">Uniswap V3</span>
              </span>
            </div>

            <div className="text-[10px] text-content-tertiary font-medium">
              Fee: <span className="text-content-secondary">~$4.50</span>
            </div>
          </div>
